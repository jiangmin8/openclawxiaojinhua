...
| `memory/context.project.md` | 当前项目上下文与进度（状态机格式） | 项目级 | 📝 活跃 |
| `memory/context.ubiquitous-language.md` | 共享词表，消除歧义 | 基础 | ✅ 已初始化 |
| `memory/PERSONAL_MODEL.md` | 🐘 4镜 Personal Model（Identity/World/Pulse/Journey） | 个人化 | 📝 按需更新 |
| `memory/context.kb.mcp.md` | MCP 协议（OpenClaw 插件体系） | 知识 | ✅ |
| `memory/context.kb.crewai.md` | CrewAI Flow/@listen 编排模式 | 知识 | ✅ |
| `memory/context.kb.agent-skills.md` | 反借口表+五轴审查+纵向切片 | 知识 | ✅ |
| `memory/context.kb.cloakbrowser.md` | 隐身浏览器（49处C++补丁） | 知识 | ✅ |
| `memory/context.kb.ruflo.md` | Ruflo Queen-led 蜂群 | 知识 | ✅ |
| `memory/context.kb.jiuwenswarm.md` | JiuwenSwarm 个人管家 | 知识 | ✅ |
| `memory/context.kb.elephant-agent.md` | Elephant Agent 4镜自进化 | 知识 | ✅ |
| `memory/context.kb.mano-p.md` | Mano-P GUI-VLA 三阶段训练 | 知识 | ✅ |
| `memory/context.kb.mattpocock-skills.md` | mattpocock/skills 语言技巧 | 知识 | ✅ |
| `memory/context.kb.ruview.md` | RuView WiFi 感知技术 | 知识 | ⏸️ 暂停 |
| `memory/subconscious/tasks.md` | Subconscious Loop 任务注册表 | 系统 | ✅ 活跃 |
| `memory/subconscious/activity.log.md` | Loop tick 活动日志 | 系统 | 📝 |
| `memory/subconscious/escalations.md` | 待大哥处理的升级队列 | 系统 | 📝 |
...
| Memory Tree 构建 | `python3 tools/memory-tree-build.py` |
| TokenJuice 压缩 | `\| python3 tools/tokenjuice/compress.py --tool <工具>` |
| Flow 引擎 | `python3 tools/flow-engine.py <flow.yaml>` |
